...
export const productEndpoints = {
  getProductDetails: (marketId: TProduct['internalId']) => ofetch(`/api/products/${marketId}`, {
    baseURL,
    onResponseError: () => {}
  }),
}

export const getProductDetails = (payload: TProductDetailsPayload) => Promise.resolve(VProduct.assert({
