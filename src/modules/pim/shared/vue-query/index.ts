...
export const usePimInfiniteQuery: typeof useInfiniteQuery = (options: any) => useInfiniteQuery(options, pimQueryClient);
export const usePimMutation: typeof useMutation = (options: any) => useMutation(options, pimQueryClient);
