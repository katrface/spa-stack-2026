...
export function toValueOnSuccess<T, TData = unknown, TVariables = unknown>(maybeGetter: MaybeGetterOnSuccess<T, TData, TVariables>, data: TData, variables: TVariables): T {
...
export function toValueOnError<T, TError = unknown, TVariables = unknown>(maybeGetter: MaybeGetterOnError<T, TError, TVariables>, error: TError, variables: TVariables): T {
  if (typeof maybeGetter === 'function') {
